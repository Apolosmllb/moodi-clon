...
export default function VideoModal({ title }: { title: string }) {
  ...
  //www.moodiday.com/video/product-review/1906-love-drops-kalli-b?autoplay=true&mute=false

  // useEffect(() => {
  //   window.onbeforeunload = function () {
  //     localStorage.add("mute_video", "true");
  //     return console.log("onbeforeunload");
  //   };
  // }, []);

  useEffect(() => {
    console.log(document.referrer); // Imprime la URL de la página que enlazó a la página actual
  }, []);
